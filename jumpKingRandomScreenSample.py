...
class JumpKingRandomScreenSample(gym.Env):
	...
	def reset(self, seed=None, options=None):
		...
		self.start_level = random.choice(
			list(self.spawn_points.keys())
		)

		# Obtener spawn correspondiente
		...
		# Reiniciar progreso del episodio
